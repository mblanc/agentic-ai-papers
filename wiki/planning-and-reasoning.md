...
long-horizon tasks {{arxiv:2601.22311}}. This is the load-bearing distinction
...
against a 7.5% single-agent baseline {{arxiv:2508.12981}}. PMC gets to a
...
models {{acl:2025.coling-main.672}}.
...
{{arxiv:2508.17196}}, and SemanticALLI caches structured intermediate
...
one-step and sequential agent variants {{arxiv:2308.03427}}, extended by
TPTU-v2 with an API retriever, a fine-tuned planner, and a demo selector for
hard-to-distinguish APIs at real commercial scale {{arxiv:2311.11315}}. DEPS
...
{{url:https://proceedings.neurips.cc/paper_files/paper/2023/hash/6b8dfb8c0c12e6fafc6c256cb08a5ca7-Abstract-Conference.html}}.
...
12 commercial agents {{arxiv:2601.10758}}. See [[safety-security-governance]]
