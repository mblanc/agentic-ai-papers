...
black-box indirect injection {{openreview:2VmB01D9Ef}}, and AutoInject turns
...
{{arxiv:2602.05746}}. The threat is not theoretical: a single poisoned email
coerced GPT-4o into exfiltrating SSH keys over 80% of the time in a real
multi-agent workflow, at $0.21 per query {{arxiv:2601.07072}}. OWASP's
LLM01:2025 entry is the field's reference definition of the attack class
{{url:https://genai.owasp.org/llmrisk/llm01-prompt-injection}}, and Simon
...
{{gh:deeplethe/forkd}}, zeroboot claims under a millisecond via the same
technique {{gh:zerobootdev/zeroboot}}, and CubeSandbox reaches sub-60ms
hardware-isolated startup {{gh:tencentcloud/cubesandbox}}. But a direct
...
knowledge base {{url:https://proceedings.neurips.cc/paper_files/paper/2024/file/eb113910e9c3f6242541c1652e30dfd6-Paper-Conference.pdf}}.
...
being scraped {{arxiv:2602.06616}}. Attacks now also target the
...
{{arxiv:2601.20615}}, and key-collision attacks hijack semantic caching at an
86% rate {{arxiv:2601.23088}}.
...
{{url:https://anthropic.com/engineering/beyond-permission-prompts}}, echoed
by Anthropic's finding that users approve 93% of prompts anyway, meaning the
approval signal had stopped meaning anything
{{url:https://anthropic.com/engineering/claude-code-auto-mode}}. AgentGuardian
learns access-control policy from an agent's own staging-phase execution
traces rather than hand-written rules {{arxiv:2601.10440}}, and Microsoft's
...
{{gh:microsoft/agent-governance-toolkit}}.
...
{{openreview:m1YYAQjO3w}}. OWASP's Excessive Agency entry
({{url:https://genai.owasp.org/llmrisk/llm062025-excessive-agency}}) is the
...
moment an agent turns rogue {{arxiv:2601.22136}}. Frontier models also have a
...
output is the only valid completion {{arxiv:2603.23509}}.
