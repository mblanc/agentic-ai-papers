...
jointly {{arxiv:2601.21916}}, ProRAG uses MCTS step-level rewards to locate
exactly where multi-hop reasoning goes wrong {{arxiv:2601.21912}}, and L-RAG
skips retrieval entirely when model uncertainty is already low
{{arxiv:2601.06551}}. But this isn't a one-directional story: a diagnostic
...
{{arxiv:2601.19827}} — the honest state of the art is "iterative retrieval
...
{{arxiv:2601.11144}}, and CIRAG preserves multiple evidence chains rather than
collapsing to one at each hop {{arxiv:2601.06799}}.
...
{{arxiv:2601.11199}}, and a distance-preserving encryption scheme lets an
untrusted cloud host the vector store while still computing similarity, at a
fraction of the cost of homomorphic encryption {{arxiv:2601.12331}}.

## Origin

WebCPM recorded 125,954 real human web-search actions to train models on
*interactive* retrieval rather than static corpus lookup {{acl:2023.acl-long.499}}
...
{{url:https://proceedings.neurips.cc/paper_files/paper/2023/hash/8fd1a81c882cd45f64958da6284f4a3f-Abstract-Conference.html}}.

## Open problems

Privacy mitigations for RAG are behind the attack surface, per the SoK's own
assessment of maturity {{arxiv:2601.03979}} — this isn't solved, just
...
{{arxiv:2601.19827}}. Enterprise-scale deployments face a harder-to-formalize
...
overlap directly with [[context-engineering]] {{arxiv:2601.10681}}.
