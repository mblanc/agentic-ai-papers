...
rate moves some models by five rank positions {{arxiv:2605.12925}}. Towards a
...
reliability are quietly diverging {{arxiv:2602.16666}}. ReliabilityBench makes
...
gap between competing models {{url:https://anthropic.com/engineering/infrastructure-noise}}.
...
level, not attributed to the base model alone {{arxiv:2605.27922}} — see
[[harness-engineering]].
...
testing catches 0% {{arxiv:2603.02601}}.
...
{{gh:thudm/agentbench}}. SWE-bench is the equivalent anchor for coding
...
GitHub issue {{url:https://swebench.com/}}. AgentTuning is the origin point
...
unseen agent tasks {{acl:2024.findings-acl.181}}.
...
{{arxiv:2601.05755}}. VirtualCrime evaluates whether models will generate and
...
goal {{arxiv:2601.13981}}. SafePro extends this to professional-context safety
