...
broadly {{arxiv:2308.11432}}, and the paper that traces "agent" from its
...
{{arxiv:2309.07864}}. A more recent methodology-centered pass links
...
dynamics to track {{arxiv:2108.07258}}. Self-evolving agents — covered in
depth in [[training-and-optimization]] — have their own entry point via a
four-phase framework {{arxiv:2404.14387}}, and agent memory (see [[memory]])
via a design-and-evaluation survey {{arxiv:2404.13501}}. Planning
(see [[planning-and-reasoning]]) gets its first systematic taxonomy here
{{arxiv:2402.02716}}, and evaluation methodology
(see [[evaluation-and-benchmarks]]) a two-dimensional taxonomy plus
enterprise-specific challenges {{arxiv:2507.21504}}.
...
dedicated survey works through {{arxiv:2503.24047}}, and materials science
{{arxiv:2506.20743}} and broader scientific-LLM development
{{arxiv:2508.21148}} each get their own data-centric treatment. Vision-language
models {{arxiv:2501.02189}} and multimodal agents {{arxiv:2402.15116}} cover
...
categorized {{arxiv:2309.15025}}. Security surveys are similarly inventory-
...
{{arxiv:2411.09523}}, but as with the RAG privacy work covered in
