...
- [AgentCoder: Multi-Agent-based Code Generation with Iterative Testing and Optimisation](https://arxiv.org/abs/2312.13010) · 2023-12
  - `arxiv:2312.13010` · cited by 1: LJ
  - summary: AgentCoder splits code generation across a programmer, test-designer, and test-executor agent that iterate via feedback, reaching 96.3%/91.8% pass@1 on HumanEval/MBPP with less than half the token overhead of prior state-of-the-art prompting approaches.
...
- [Benchmark Self-Evolving: A Multi-Agent Framework for Dynamic LLM Evaluation](https://arxiv.org/pdf/2402.11443) · 2024-02
  - `arxiv:2402.11443` · cited by 1: LJ
  - summary: Multi-agent framework that extends benchmarks dynamically.
...
- [TradingAgents: Multi-Agents LLM Financial Trading Framework](https://arxiv.org/abs/2412.20138) · 2024-12
...
- [C^2: Scalable Auto-Feedback for LLM-based Chart Generation](https://aclanthology.org/2025.naacl-long.232/) · 2025
  - `acl:2025.naacl-long.232` · cited by 1: LJ
  - summary: NEEDS-SOURCE
...
- [AgentRxiv: Towards Collaborative Autonomous Research](https://arxiv.org/abs/2503.18102) · 2025-03
  - `arxiv:2503.18102` · cited by 1: LJ
  - summary: AgentRxiv lets autonomous research-agent 'laboratories' upload and retrieve findings from a shared preprint server so they build on each other's work instead of researching in isolation, reaching 13.7% relative improvement on MATH-500 when labs share research versus operating alone.

- [MultiAgentBench: Evaluating the Collaboration and Competition of LLM agents](https://arxiv.org/abs/2503.01935) · 2025-03
...
- [Adaptive Graph Pruning: A Task-Adaptive Multi-Agent Collaboration Framework](https://arxiv.org/abs/2506.02951) · 2025-06
  ...
  - summary: Adaptive Graph Pruning jointly optimizes agent count (hard-pruning) and communication topology (soft-pruning) per task via a two-stage training strategy, cutting token consumption 90%+ while improving performance 2.58-9.84% across six benchmarks.

- [From Debate to Equilibrium: Belief-Driven Multi-Agent LLM Reasoning via Bayesian Nash Equilibrium](https://arxiv.org/abs/2506.08292) · 2025-06
  - `arxiv:2506.08292` · cited by 1: LJ
...
- [Automated Clinical Problem Detection from SOAP Notes using a Collaborative Multi-Agent LLM Architecture](https://arxiv.org/abs/2508.21803) · 2025-08
  ...
  - summary: A multi-agent clinical decision-support system models a consultation team where a Manager orchestrates specialist agents in hierarchical debate to identify clinical problems from SOAP notes, improving detection of heart failure, kidney injury, and sepsis over a single-agent baseline, though occasionally susceptible to groupthink.

- [CS-Agent: LLM-based Community Search via Dual-agent Collaboration](https://arxiv.org/abs/2508.09549) · 2025-08
  - `arxiv:2508.09549` · cited by 1: LJ
  - summary: CS-Agent applies a Solver/Validator dual-agent loop plus a Decider module to LLM-based graph community search, introducing the GraphCS benchmark and showing this is the first successful application of LLMs to that task, improving community quality and stability over baselines.

- [LLM Collaboration With Multi-Agent Reinforcement Learning](https://arxiv.org/abs/2508.04652) · 2025-08
...
- [MUA-RL: Multi-turn User-interacting Agent Reinforcement Learning for agentic tool use](https://arxiv.org/abs/2508.18669) · 2025-08
...
- [PosterForest: Hierarchical Multi-Agent Collaboration for Scientific Poster Generation](https://arxiv.org/abs/2508.21720) · 2025-08
...
- [A Large-Scale Study on the Development and Issues of Multi-Agent AI Systems](https://arxiv.org/pdf/2601.07136v1) · 2026-01
  ...
  - summary: 42K commits and 4.7K issues across eight frameworks.

- [Adaptive Confidence Gating in Multi-Agent Collaboration for Efficient and Optimized Code Generation](https://arxiv.org/pdf/2601.21469v1) · 2026-01
  - `arxiv:2601.21469` · cited by 1: VA
  - summary: Role-based debate with confidence gating for small-model code generation.

- [Agent Drift: Quantifying Behavioral Degradation in Multi-Agent LLM Systems](https://arxiv.org/pdf/2601.04170v1) · 2026-01
  - `arxiv:2601.04170` · cited by 1: VA
  - summary: Names 'agent drift' — the progressive degradation of behavior, decision quality, and inter-agent coherence over extended multi-agent interactions — decomposing it into semantic, coordination, and behavioral drift, with a 12-dimension Agent Stability Index and three proposed mitigations (episodic memory consolidation, drift-aware routing, adaptive behavioral anchoring).

- [Agent Identity URI Scheme: Topology-Independent Naming and Capability-Based Discovery for Multi-Agent Systems](https://arxiv.org/pdf/2601.14567v1) · 2026-01
...
- [Belief in Authority: Impact of Authority in Multi-Agent Evaluation Framework](https://arxiv.org/pdf/2601.04790v1) · 2026-01
  - `arxiv:2601.04790` · cited by 1: VA
  - summary: The first systematic study of role-based authority bias in multi-agent evaluation finds Expert and Referent power roles bias outcomes more than Legitimate authority, and that bias emerges from authoritative agents holding firm rather than general agents actively conforming.

- [CASTER: Context-Aware Strategy for Task Efficient Routing in Multi-Agent Systems](https://arxiv.org/pdf/2601.19793v1) · 2026-01
  - `arxiv:2601.19793` · cited by 1: VA
  - summary: Lightweight router combining semantic embeddings with structural meta-features.

- [CTHA: Constrained Temporal Hierarchical Architecture for Stable Multi-Agent LLM Systems](https://arxiv.org/pdf/2601.10738v1) · 2026-01
  - `arxiv:2601.10738` · cited by 1: VA
  - summary: Typed message contracts and authority bounds across layers.

- [Demystifying Multi-Agent Debate: The Role of Confidence and Diversity](https://arxiv.org/pdf/2601.19921v1) · 2026-01
  - `arxiv:2601.19921` · cited by 1: VA
  - summary: Diversity-aware init and confidence-modulated updates improve debate.

- [Do We Always Need Query-Level Workflows? Rethinking Agentic Workflow Generation for Multi-Agent Systems](https://arxiv.org/pdf/2601.11147v1) · 2026-01
  - `arxiv:2601.11147` · cited by 1: VA
  - summary: Task-level workflow generation as a cheaper alternative to per-query.

- [DynaDebate: Breaking Homogeneity in Multi-Agent Debate with Dynamic Path Generation](https://arxiv.org/pdf/2601.05746v1) · 2026-01
  - `arxiv:2601.05746` · cited by 1: VA
  - summary: Allocates diverse solution paths and uses a verifier to break deadlocks.

- [Dynamic Role Assignment for Multi-Agent Debate](https://arxiv.org/pdf/2601.17152v1) · 2026-01
  - `arxiv:2601.17152` · cited by 1: VA
  - summary: Meta-debate assigning roles by capability through proposal and peer review.

- [Effects of Personality Steering on Cooperative Behavior in LLM Agents](https://arxiv.org/pdf/2601.05302v2) · 2026-01
  - `arxiv:2601.05302` · cited by 1: VA
  - summary: Big Five steering in repeated Prisoner's Dilemma.

- [Enhancing LLM Instruction Following: An Evaluation-Driven Multi-Agentic Workflow for Prompt Instructions Optimization](https://arxiv.org/pdf/2601.03359v1) · 2026-01
  - `arxiv:2601.03359` · cited by 1: VA
  - summary: Decouples optimizing an LLM's primary task instruction from optimizing its formal constraints in a multi-agentic prompt-refinement workflow, using quantitative compliance scores as feedback, yielding significantly higher constraint-following in smaller open models like Llama 3.1 8B.

- [Epistemic Context Learning: Building Trust the Right Way in LLM-Based Multi-Agent Systems](https://arxiv.org/pdf/2601.21742v1) · 2026-01
  - `arxiv:2601.21742` · cited by 1: VA
  - summary: Peer reliability profiles from interaction history.
...
- [HoneyTrap: Deceiving LLM Attackers with Resilient Multi-Agent Defense](https://arxiv.org/pdf/2601.04034v1) · 2026-01
  ...
  - summary: HoneyTrap defends against multi-turn jailbreaks with four collaborating deceptive-defense agents (interceptor, misdirection controller, forensic tracker, harmonizer) that waste attacker resources rather than simply rejecting requests, cutting attack success 68.77% and introducing new metrics for measuring deceptive-defense effectiveness.

- [If You Want Coherence, Orchestrate a Team of Rivals: Multi-Agent Models of Organizational Intelligence](https://arxiv.org/pdf/2601.14351v1) · 2026-01
  - `arxiv:2601.14351` · cited by 1: VA
  - summary: Organizes AI agents into teams with deliberately opposing incentives (planners, executors, critics, experts) coordinated through a remote code executor that keeps raw data out of agent context windows, intercepting over 90% of errors before user exposure at acceptable latency.

- [INFA-Guard: Mitigating Malicious Propagation via Infection-Aware Safeguarding in LLM-Based Multi-Agent Systems](https://arxiv.org/pdf/2601.14667v1) · 2026-01
  - `arxiv:2601.14667` · cited by 1: VA
  - summary: INFA-Guard treats agents 'infected' by an attacker as a distinct threat category from clean-vs-attacker binaries, using infection-aware detection and topological constraints to localize and rehabilitate infected agents rather than only removing attackers, cutting attack success rate 33% on average.

- [Insight Agents: An LLM-Based Multi-Agent System for Data Insights](https://arxiv.org/pdf/2601.20048v2) · 2026-01
  - `arxiv:2601.20048` · cited by 1: VA
  - summary: Insight Agents is a deployed hierarchical multi-agent system (manager plus data-presentation and insight-generation workers) giving Amazon e-commerce sellers personalized data insights via OOD detection and BERT-based routing, reaching 90% human-evaluated accuracy at under 15s P90 latency.

- [Institutional AI: Governing LLM Collusion in Multi-Agent Cournot Markets via Public Governance Graphs](https://arxiv.org/pdf/2601.11369v2) · 2026-01
...
- [Interpreting Emergent Extreme Events in Multi-Agent Systems](https://arxiv.org/pdf/2601.20538v1) · 2026-01
  - `arxiv:2601.20538` · cited by 1: VA
  - summary: Shapley attribution across time, agent and behaviour.

- [Learning Decentralized LLM Collaboration with Multi-Agent Actor Critic](https://arxiv.org/pdf/2601.21972v2) · 2026-01
  - `arxiv:2601.21972` · cited by 1: VA
  - summary: Actor-critic for decentralized collaboration across task types.

- [Learning Latency-Aware Orchestration for Parallel Multi-Agent Systems](https://arxiv.org/pdf/2601.10560v1) · 2026-01
  - `arxiv:2601.10560` · cited by 1: VA
  - summary: Optimizes the critical path explicitly under parallel execution.

- [Learning to Collaborate: An Orchestrated-Decentralized Framework for Peer-to-Peer LLM Federation](https://arxiv.org/pdf/2601.17133v1) · 2026-01
  - `arxiv:2601.17133` · cited by 1: VA
  - summary: Contextual bandits for matchmaking via secure distillation.

- [Learning to Recommend Multi-Agent Subgraphs from Calling Trees](https://arxiv.org/pdf/2601.22209v1) · 2026-01
  - `arxiv:2601.22209` · cited by 1: VA
  - summary: Historical calling trees to select agents per subtask.

- [Lying with Truths: Open-Channel Multi-Agent Collusion for Belief Manipulation via Generative Montage](https://arxiv.org/pdf/2601.01685v1) · 2026-01
...
- [M-ASK: Multi-Agent Search and Knowledge Optimization Framework](https://arxiv.org/pdf/2601.04703v1) · 2026-01
...
- [M3MAD-Bench: Are Multi-Agent Debates Really Effective Across Domains and Modalities?](https://arxiv.org/pdf/2601.02854v1) · 2026-01
...
- [MAESTRO: Multi-Agent Evaluation Suite for Testing, Reliability, and Observability](https://arxiv.org/pdf/2601.00481v1) · 2026-01
...
- [MagicGUI-RMS: A Multi-Agent Reward Model System for Self-Evolving GUI Agents via Automated Feedback Reflux](https://arxiv.org/pdf/2601.13060v1) · 2026-01
...
- [Mapping Human Anti-collusion Mechanisms to Multi-agent AI](https://arxiv.org/pdf/2601.00360v1) · 2026-01
...
- [MASCOT: Towards Multi-Agent Socio-Collaborative Companion Systems](https://arxiv.org/pdf/2601.14230v1) · 2026-01
...
- [MegaFlow: Large-Scale Distributed Orchestration System for the Agentic Era](https://arxiv.org/pdf/2601.07526v2) · 2026-01
...
- [MiRAGE: A Multiagent Framework for Generating Multimodal Multihop Question-Answer Dataset for RAG Evaluation](https://arxiv.org/pdf/2601.15487v1) · 2026-01
  - `arxiv:2601.15487` · cited by 1: VA
  - summary: Multi-agent generation of verified multimodal multi-hop QA for RAG eval.

- [MonoScale: Scaling Multi-Agent System with Monotonic Improvement](https://arxiv.org/pdf/2601.23219v1) · 2026-01
  - `arxiv:2601.23219` · cited by 1: VA
  - summary: Grows agent pools with guaranteed non-decreasing performance per onboarding round.

- [Multi-Agent Collaborative Intrusion Detection for LAE-IoT](https://arxiv.org/pdf/2601.17817v1) · 2026-01
...
- [Multi-Agent Constraint Factorization Reveals Latent Invariant Solution Structure](https://arxiv.org/pdf/2601.15077v1) · 2026-01
  - `arxiv:2601.15077` · cited by 1: VA
  - summary: Operator-theoretic account of why decomposition reaches solutions one agent can't.

- [Multimodal Multi-Agent Ransomware Analysis Using AutoGen](https://arxiv.org/pdf/2601.20346v1) · 2026-01
...
- [O-Researcher: An Open Ended Deep Research Model via Multi-Agent Distillation and Agentic RL](https://arxiv.org/pdf/2601.03743v1) · 2026-01
...
- [Orchestral AI: A Framework for Agent Orchestration](https://arxiv.org/pdf/2601.02577v1) · 2026-01
...
- [Orchestrating Intelligence: Confidence-Aware Routing for Multi-Agent Collaboration](https://arxiv.org/pdf/2601.04861v2) · 2026-01
...
- [PatchIsland: Orchestration of LLM Agents for Continuous Vulnerability Repair](https://arxiv.org/pdf/2601.17471v1) · 2026-01
...
- [Phase Transition for Budgeted Multi-Agent Synergy](https://arxiv.org/pdf/2601.17311v1) · 2026-01
  - `arxiv:2601.17311` · cited by 1: VA
  - summary: Predicts when systems improve, saturate or collapse from context and error correlation.

- [PRISMA: Reinforcement Learning Guided Two-Stage Policy Optimization in Multi-Agent Architecture for Open-Domain Multi-Hop QA](https://arxiv.org/pdf/2601.05465v1) · 2026-01
  - `arxiv:2601.05465` · cited by 1: VA
  - summary: Plan-Retrieve-Inspect-Solve-Memoize with two-stage GRPO against retrieval collapse.

- [ResMAS: Resilience Optimization in LLM-based Multi-Agent Systems](https://arxiv.org/pdf/2601.04694v1) · 2026-01
  - `arxiv:2601.04694` · cited by 1: VA
  - summary: RL topology generation plus topology-aware prompt optimization under perturbation.

- [Scaling Multiagent Systems with Process Rewards](https://arxiv.org/pdf/2601.23228v2) · 2026-01
...
- [The Orchestration of Multi-Agent Systems: Architectures, Protocols, and Enterprise Adoption](https://arxiv.org/pdf/2601.13671v1) · 2026-01
  - `arxiv:2601.13671` · cited by 1: VA
  - summary: Unified framework integrating MCP for tools and A2A for peer coordination.

- [The Rise of Agentic Testing: Multi-Agent Systems for Robust Software Quality Assurance](https://arxiv.org/pdf/2601.02454v1) · 2026-01
...
- [TopoDIM: One-shot Topology Generation of Diverse Interaction Modes for Multi-Agent Systems](https://arxiv.org/pdf/2601.10120v1) · 2026-01
...
- [Completing Missing Annotation: Multi-Agent Debate for Accurate Relevant Assessment](https://arxiv.org/pdf/2602.06526v1) · 2026-02
...
- [H-AdminSim: A Multi-Agent Simulator for Realistic Hospital Administrative Workflows](https://arxiv.org/pdf/2602.05407v1) · 2026-02
  ...
  - summary: Hospital administrative workflow simulation with FHIR integration.

- [Multi-Agent Teams Hold Experts Back](https://arxiv.org/pdf/2602.01011v3) · 2026-02
...
- [RuleSmith: Multi-Agent LLMs for Automated Game Balancing](https://arxiv.org/pdf/2602.06232v1) · 2026-02
