...
SWE-bench research builds on [gh:swe-agent/swe-agent](https://github.com/SWE-agent/SWE-agent). Around it sits a
cluster of similarly-shaped open harnesses — OpenHands as a self-hosted control
center wiring agents into GitHub and Slack [gh:openhands/openhands](https://github.com/OpenHands/OpenHands), OpenCode
with separate full-access and read-only modes [gh:anomalyco/opencode](https://github.com/anomalyco/opencode), and
...
[url:https://blog.langchain.com/open-swe-an-open-source-framework-for-internal-coding-agents](https://blog.langchain.com/open-swe-an-open-source-framework-for-internal-coding-agents/).
...
diff [arxiv:2601.04886](https://arxiv.org/pdf/2601.04886v2). Core and peripheral developers use agents
differently, with real differences in review and verification behavior
[arxiv:2601.20106](https://arxiv.org/pdf/2601.20106v1). A 40,214-PR comparison of developer versus agentic PRs
looked at merge outcomes and review features directly [arxiv:2601.18749](https://arxiv.org/pdf/2601.18749v1), and
a study of 8,106 fix-related agent PRs catalogued *why* they stay unmerged
[arxiv:2602.00164](https://arxiv.org/pdf/2602.00164v1) — a very different question from "does the agent pass the
benchmark."
...
[url:https://resources.anthropic.com/hubfs/2026%20Agentic%20Coding%20Trends%20Report.pdf](https://resources.anthropic.com/hubfs/2026%20Agentic%20Coding%20Trends%20Report.pdf?hsLang=en)
...
modern coding agent's tool loop now takes [arxiv:2305.04032](http://arxiv.org/abs/2305.04032).
...
coordination structures [arxiv:2601.13295](https://arxiv.org/pdf/2601.13295v2) — the individual-task success
...
always move together [arxiv:2601.21276](https://arxiv.org/pdf/2601.21276v1), and "silent" agent PRs with no
commentary carry measurable complexity and vulnerability implications
[arxiv:2601.21102](https://arxiv.org/pdf/2601.21102v1) — trust calibration for agent-authored code is still an
