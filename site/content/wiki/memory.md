...
[arxiv:2603.27910](https://arxiv.org/abs/2603.27910), while a more formally grounded approach models memory as
...
frontier models [arxiv:2603.17781](https://arxiv.org/abs/2603.17781).
...
reference pattern [gh:letta-ai/letta](https://github.com/letta-ai/letta); mem0 [gh:mem0ai/mem0](https://github.com/mem0ai/mem0), Zep
[gh:getzep/zep](https://github.com/getzep/zep), and cognee [gh:topoteretes/cognee](https://github.com/topoteretes/cognee) are the common
...
changes [url:https://github.blog/ai-and-ml/github-copilot/building-an-agentic-memory-system-for-github-copilot](https://github.blog/ai-and-ml/github-copilot/building-an-agentic-memory-system-for-github-copilot/).
...
reranked retrieval [arxiv:2412.15266](https://arxiv.org/abs/2412.15266). Read this as license to not over-commit
...
[gh:letta-ai/letta](https://github.com/letta-ai/letta). The most current entry point into where the field is
heading is the survey organizing memory by substrate, cognitive mechanism, and
subject [arxiv:2602.06052](https://arxiv.org/pdf/2602.06052v3).
...
[arxiv:2601.05504](https://arxiv.org/pdf/2601.05504v2). RAG knowledge bases can be extracted wholesale by an
attacker who schedules non-redundant queries, reaching 66.8% corpus coverage in
1,000 queries [arxiv:2601.15678](https://arxiv.org/pdf/2601.15678v2). Governance is catching up but is still
mostly bespoke: MemArchitect treats decay, conflict resolution, and privacy as
explicit policy rather than passive storage [arxiv:2603.18330](https://arxiv.org/abs/2603.18330), and MemTrust
proposes a hardware zero-trust architecture for memory shared across agents and
apps [arxiv:2601.07004](https://arxiv.org/pdf/2601.07004v1) — neither is yet a settled default the way vector
...
[arxiv:2601.09760](https://arxiv.org/pdf/2601.09760v1). That's an open correctness problem, not just an
efficiency one.
