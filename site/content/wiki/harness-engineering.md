...
benchmark results by 5+ points [url:https://resources.anthropic.com/hubfs/2026%20Agentic%20Coding%20Trends%20Report.pdf](https://resources.anthropic.com/hubfs/2026%20Agentic%20Coding%20Trends%20Report.pdf?hsLang=en)
...
[url:https://blog.langchain.com/tuning-the-harness-not-the-model-a-nemotron-3-ultra-playbook](https://blog.langchain.com/tuning-the-harness-not-the-model-a-nemotron-3-ultra-playbook).
...
[arxiv:2606.09498](https://arxiv.org/abs/2606.09498). Meta-Harness generalizes the same idea to harness code
...
[arxiv:2603.28052](https://arxiv.org/abs/2603.28052). RHO (Retrospective Harness Optimization) pushes this
...
[gh:wbopan/retro-harness](https://github.com/wbopan/retro-harness). Live-SWE-agent is the extreme version: an agent
...
proprietary ones [arxiv:2511.13646](https://arxiv.org/html/2511.13646v3).

This has produced a small ecosystem of general-purpose harness optimizers as
products, not just papers: meta-agent [gh:canvas-org/meta-agent](https://github.com/canvas-org/meta-agent), metaharness
[gh:superagenticai/metaharness](https://github.com/SuperagenticAI/metaharness), auto-harness [gh:neosigmaai/auto-harness](https://github.com/neosigmaai/auto-harness),
and harness-evolver [gh:raphaelchristi/harness-evolver](https://github.com/raphaelchristi/harness-evolver) all implement some
...
the first widely-used harnesses [arxiv:2306.03314](http://arxiv.org/abs/2306.03314).
...
[arxiv:2606.09498](https://arxiv.org/abs/2606.09498) — which is precisely the argument for the self-improving
