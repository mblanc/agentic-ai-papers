...
- [Are We All Using Agents the Same Way? An Empirical Study of Core and Peripheral Developers Use of Coding Agents](https://arxiv.org/pdf/2601.20106v1) · 2026-01
  - `arxiv:2601.20106` · cited by 1: VA
  - summary: Core vs peripheral developers differ in review and verification behaviour.

- [CooperBench: Why Coding Agents Cannot be Your Teammates Yet](https://arxiv.org/pdf/2601.13295v2) · 2026-01
  - `arxiv:2601.13295` · cited by 1: VA
  - summary: 600+ collaborative coding tasks under varied coordination structures.

- [Fingerprinting AI Coding Agents on GitHub](https://arxiv.org/pdf/2601.17406v1) · 2026-01
  - `arxiv:2601.17406` · cited by 1: VA
  - summary: Behavioural signatures attributing PRs to specific agents.

- [How to Build AI Agents by Augmenting LLMs with Codified Human Expert Domain Knowledge? A Software Engineering Framework](https://arxiv.org/pdf/2601.15153v1) · 2026-01
  - `arxiv:2601.15153` · cited by 1: VA
  - summary: A software-engineering framework for baking scarce human-expert domain knowledge into an agent via a request classifier, RAG code generation, and codified expert rules, letting non-experts reach expert-rated output (206% quality gain) in a data-visualization case study.

- [Let's Make Every Pull Request Meaningful: An Empirical Analysis of Developer and Agentic Pull Requests](https://arxiv.org/pdf/2601.18749v1) · 2026-01
  - `arxiv:2601.18749` · cited by 1: VA
  - summary: 40,214 PRs compared on merge outcomes and review features.

- [LLM-Based Agentic Systems for Software Engineering: Challenges and Opportunities](https://arxiv.org/pdf/2601.09822v2) · 2026-01
  - `arxiv:2601.09822` · cited by 1: VA
  - summary: Review across the SDLC covering frameworks and orchestration challenges.

- [More Code, Less Reuse: Investigating Code Quality and Reviewer Sentiment towards AI-generated Pull Requests](https://arxiv.org/pdf/2601.21276v1) · 2026-01
...
- [Tokenomics: Quantifying Where Tokens Are Used in Agentic Software Engineering](https://arxiv.org/pdf/2601.14470v1) · 2026-01
